      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] z-50 top-[3px] z-50 md:top[5] md:right-[5]">
              <Button 
                disabled={isLoadingAddress}
                type="small" 
                onClick = {(e) => {
        ...
        <div className="mb-12 flex items-center gap-5">
          ...
          />
          <label htmlFor="priority" className="font-medium">Want to your give your order priority?</label>
        </div>
